...
GO
ALTER TABLE [dbo].[Author] ALTER COLUMN [AuthorName] NVARCHAR (15) NOT NULL;

ALTER TABLE [dbo].[Author] ALTER COLUMN [AuthorSurname] NVARCHAR (15) NOT NULL;

ALTER TABLE [dbo].[Author] ALTER COLUMN [TFN] NVARCHAR (11) NOT NULL;
